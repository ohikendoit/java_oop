...
public class BoardService {
	...
	public static void main(String[] args) {
		...
		boardService.create("첫 번째 게시글", "정윤성");
		boardService.create("두 번째 게시글", "정윤성");
		boardService.create("세 번째 게시글", "정윤성");
		boardService.create("네 번째 게시글", "정윤성");
		boardService.create("다섯 번째 게시글", "정윤성");
		boardService.create("여섯 번째 게시글", "정윤성");
